...
//- `electricity.css` sisältää ulkoasun määrittelyt, kuten fontit, värit ja asettelut.
import "./electricity.css";   

// Import backgroud image and Container component.
import background from './background.png';
import Container from "../../components/container/Container";

/**
 * Retrieves electricity price data from the API and visualises it as a graph.
 * 
 * @component
...
const StockData = () => {
  ...
  */
  ...
  return (
    /* Container komponentti asettaa taustakuvan ja yleisen asettelun.
        - Sisältää:
            1. Otsikon ja hintatiedot (`stockdata-header`)
            2. Kaavion sähkön hintojen visualisointiin (`stockdata-graph`)
    */
    <Container className="stockdata-container" backgroundImage={background}>

      {/* Otsikko ja hintatiedot */}
      <div className="stockdata-header">

        {/* **Otsikko, joka näyttää päivän sähkön hinnat** */}
        {/* Päivämäärä haetaan dynaamisesti ja muotoillaan suomalaiseen tapaan */}
        <h2 className="stockdata-title">Sähkön hinta tänään {new Date().toLocaleDateString("fi-FI")}</h2>

        {/* Hintatiedot */}
        {/* Sisältää nykyhetken hinnan, päivän halvimman ja kalleimman hinnan */}
        <div className="stockdata-prices">
